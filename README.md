...
Modified playground for training Vision Transformers (ViT) and its related models on CIFAR-10, a common benchmark dataset in computer vision. Added benchmarks and related functions to test squentropy loss function on various datasets.
