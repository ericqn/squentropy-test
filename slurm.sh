...
#SBATCH --partition=gpuA100x4         # specify queue, if this doesn’t submit try gpu-shared
#SBATCH --gpus=1
...
#SBATCH --time=24:00:00       # set maximum run time in H:m:S
...
python path/train_cifar10.py --net simple_model_9 --n_epochs 200 --n_layers 6 --n_heads 8 --bs 64 --dimhead 64