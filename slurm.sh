...
python /u/enguyen3/squentropy-test/train_cifar10.py --dataset cifar10 --net res18 --n_epochs 200 --loss_eq sqen_alpha --lr 0.02
python /u/enguyen3/squentropy-test/train_cifar10.py --dataset cifar10 --net res18 --n_epochs 200 --loss_eq sqen --lr 0.02
