...
python /u/enguyen3/squentropy-test/train_cifar10.py --dataset cifar10 --net vit --subset_prop 0.1 --n_epochs 200 --loss_eq sqen_neg_rs --lr 0.0002
python /u/enguyen3/squentropy-test/train_cifar10.py --dataset cifar10 --net vit --subset_prop 0.1 --n_epochs 200 --loss_eq sqen_rs --lr 0.0002 --sqen_alpha 0.1
