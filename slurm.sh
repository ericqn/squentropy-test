...
python /u/enguyen3/squentropy-test/train_cifar10.py --dataset svhn --net vgg --n_epochs 200 --loss_eq sqen_alpha --lr 2e-4
python /u/enguyen3/squentropy-test/train_cifar10.py --dataset svhn --net vgg --n_epochs 200 --loss_eq sqen --lr 2e-4
python /u/enguyen3/squentropy-test/train_cifar10.py --dataset svhn --net vgg --n_epochs 200 --loss_eq cross --lr 2e-4
